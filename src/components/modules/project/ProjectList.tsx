...
import { ProjectCard } from '~/components/magic-ui/project-card'
      ...
      <div className="grid min-w-0 grid-cols-1 gap-12 lg:grid-cols-3">
        {props.projects.map((project) => {
          ...
          const links = [
            ...
            {
              type: 'Website',
              href: realMeataData.website ?? '',
              icon: <GlobeIcon className="size-3" />,
            },
          ]
          if (!realMeataData.website) {
            links.pop()
          }
          if (!realMeataData.github) {
            links.shift()
          }
